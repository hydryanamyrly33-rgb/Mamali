...
نسخه زنده: `3.5.0` — ورود گوگل در اپ Chrome اندروید، قفل یک‌دستگاهی، اندروید عمودی / ویندوز افقی، آرشیو نسخه‌ها.
...
- `major` برای تغییر ناسازگار یا معماری بزرگ: `3.2.0 → 4.0.0`
- `minor` برای قابلیت جدید سازگار: `3.2.0 → 3.3.0`
- `patch` برای رفع اشکال: `3.2.0 → 3.2.1`
