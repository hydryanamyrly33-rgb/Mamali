# Mamali Orbit — راهنمای کامل برای AI بعدی (نسخه 3.5.0)
...
- فعلی: `3.5.0`
- قبلی: `3.4.0` → `3.3.1` → `3.3.0` → `3.2.0` → `3.1.0` → `3.0.0`
...
---
Mamali Orbit 3.5.0 — Arena.ai Agent — 2026-08-19
